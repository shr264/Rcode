...
genodata.path1='Pop1_mrk_005.txt'
...
presel.pos=read.table("lm_mrk_005.txt",header=T) 
...
data1=read.table("Pop1_data_005.txt",header=T)  
...
write.table(Performance,col.names=FALSE,row.names=FALSE,file="BayesKRperform5.csv", sep=",")
