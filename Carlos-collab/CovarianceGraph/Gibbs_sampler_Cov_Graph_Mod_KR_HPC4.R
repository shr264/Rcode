...
genodata.path1='Pop1_mrk_004.txt'
...
presel.pos=read.table("lm_mrk_004.txt",header=T) 
...
write.table(Performance,col.names=FALSE,row.names=FALSE,file="BayesKRperform4.csv", sep=",")
