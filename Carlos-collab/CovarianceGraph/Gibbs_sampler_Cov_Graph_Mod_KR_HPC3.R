...
genodata.path1='Pop1_mrk_003.txt'
...
presel.pos=read.table("lm_mrk_003.txt",header=T) 
...
data1=read.table("Pop1_data_003.txt",header=T)  
...
write.table(Performance,col.names=FALSE,row.names=FALSE,file="BayesKRperform3.csv", sep=",")
