...
genodata.path1='Pop1_mrk_001.txt'
...
presel.pos=read.table("lm_mrk_001.txt",header=T) 
...
write.table(Performance,col.names=FALSE,row.names=FALSE,file="BayesKRperform1.csv", sep=",")
