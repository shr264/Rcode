...
Graph3_9=read.table("Graph3 9 .txt",header=F)
...
Adjac=Adj(Nodes=Graph3_9,nloci=nloci)

Score3_9=getLk(gamma=0.5,M=3,N1=10,D0=Adjac)

save(Score3_9,file=paste("score",toString(3),toString(9),".rdata",sep=""))
