...
Graph4_10=read.table("Graph4 10 .txt",header=F)
...
Adjac=Adj(Nodes=Graph4_10,nloci=nloci)

Score4_10=getLk(gamma=0.5,M=3,N1=10,D0=Adjac)

save(Score4_10,file=paste("score",toString(4),toString(10),".rdata",sep=""))
