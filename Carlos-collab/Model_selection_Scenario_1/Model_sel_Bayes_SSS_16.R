...
Graph4_8=read.table("Graph4 8 .txt",header=F)
...
Adjac=Adj(Nodes=Graph4_8,nloci=nloci)

Score4_8=getLk(gamma=0.5,M=3,N1=10,D0=Adjac)

save(Score4_8,file=paste("score",toString(4),toString(8),".rdata",sep=""))
