...
Graph4_4=read.table("Graph4 4 .txt",header=F)
...
Adjac=Adj(Nodes=Graph4_4,nloci=nloci)

Score4_4=getLk(gamma=0.5,M=3,N1=10,D0=Adjac)

save(Score4_4,file=paste("score",toString(4),toString(4),".rdata",sep=""))
