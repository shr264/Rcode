...
Graph4_1=read.table("Graph4 1 .txt",header=F)
...
Adjac=Adj(Nodes=Graph4_1,nloci=nloci)

Score4_1=getLk(gamma=0.5,M=3,N1=10,D0=Adjac)

save(Score4_1,file=paste("score",toString(4),toString(1),".rdata",sep=""))
