...
Graph3_14=read.table("Graph3 14 .txt",header=F)
...
Adjac=Adj(Nodes=Graph3_14,nloci=nloci)

Score3_14=getLk(gamma=0.5,M=3,N1=10,D0=Adjac)

save(Score3_14,file=paste("score",toString(3),toString(14),".rdata",sep=""))
