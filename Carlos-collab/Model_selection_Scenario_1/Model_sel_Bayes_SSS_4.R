...
Graph4_2=read.table("Graph4 2 .txt",header=F)
...
Adjac=Adj(Nodes=Graph4_2,nloci=nloci)

Score4_2=getLk(gamma=0.5,M=3,N1=10,D0=Adjac)

save(Score4_2,file=paste("score",toString(4),toString(2),".rdata",sep=""))
