...
Graph3_4=read.table("Graph3 4 .txt",header=F)
...
Adjac=Adj(Nodes=Graph3_4,nloci=nloci)

Score3_4=getLk(gamma=0.5,M=3,N1=10,D0=Adjac)

save(Score3_4,file=paste("score",toString(3),toString(4),".rdata",sep=""))
