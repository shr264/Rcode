...
#--To read genotypes
#3=1,2
QTL1=read.table("Pop1_qtl_003.txt",header=F)                                     
...
Graph3_11=read.table("Graph3 11 .txt",header=F)
...
Adjac=Adj(Nodes=Graph3_11,nloci=nloci)

Score3_11=getLk(gamma=0.5,M=3,N1=10,D0=Adjac)

save(Score3_11,file=paste("score",toString(3),toString(11),".rdata",sep=""))
