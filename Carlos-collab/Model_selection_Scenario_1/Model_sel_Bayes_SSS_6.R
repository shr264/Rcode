...
Graph4_3=read.table("Graph4 3 .txt",header=F)
...
Adjac=Adj(Nodes=Graph4_3,nloci=nloci)

Score4_3=getLk(gamma=0.5,M=3,N1=10,D0=Adjac)

save(Score4_3,file=paste("score",toString(4),toString(3),".rdata",sep=""))
