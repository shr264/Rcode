...
Graph4_13=read.table("Graph4 13 .txt",header=F)
...
Adjac=Adj(Nodes=Graph4_13,nloci=nloci)

Score4_13=getLk(gamma=0.5,M=3,N1=10,D0=Adjac)

save(Score4_13,file=paste("score",toString(4),toString(13),".rdata",sep=""))
