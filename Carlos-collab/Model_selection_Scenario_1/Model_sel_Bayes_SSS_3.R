...
Graph3_2=read.table("Graph3 2 .txt",header=F)
...
Adjac=Adj(Nodes=Graph3_2,nloci=nloci)

Score3_2=getLk(gamma=0.5,M=3,N1=10,D0=Adjac)

save(Score3_2,file=paste("score",toString(3),toString(2),".rdata",sep=""))
