...
Graph3_8=read.table("Graph3 8 .txt",header=F)
...
Adjac=Adj(Nodes=Graph3_8,nloci=nloci)

Score3_8=getLk(gamma=0.5,M=3,N1=10,D0=Adjac)

save(Score3_8,file=paste("score",toString(3),toString(8),".rdata",sep=""))
