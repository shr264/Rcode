...
Graph3_13=read.table("Graph3 13 .txt",header=F)
...
Adjac=Adj(Nodes=Graph3_13,nloci=nloci)

Score3_13=getLk(gamma=0.5,M=3,N1=10,D0=Adjac)

save(Score3_13,file=paste("score",toString(3),toString(13),".rdata",sep=""))
