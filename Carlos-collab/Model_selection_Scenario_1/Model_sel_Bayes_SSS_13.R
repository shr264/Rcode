...
Graph3_7=read.table("Graph3 7 .txt",header=F)
...
Adjac=Adj(Nodes=Graph3_7,nloci=nloci)

Score3_7=getLk(gamma=0.5,M=3,N1=10,D0=Adjac)

save(Score3_7,file=paste("score",toString(3),toString(7),".rdata",sep=""))
