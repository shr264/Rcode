...
Graph3_15=read.table("Graph3 15 .txt",header=F)
...
Adjac=Adj(Nodes=Graph3_15,nloci=nloci)

Score3_15=getLk(gamma=0.5,M=3,N1=10,D0=Adjac)

save(Score3_15,file=paste("score",toString(3),toString(15),".rdata",sep=""))
