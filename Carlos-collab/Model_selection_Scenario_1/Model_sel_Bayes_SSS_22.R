...
Graph4_11=read.table("Graph4 11 .txt",header=F)
...
Adjac=Adj(Nodes=Graph4_11,nloci=nloci)

Score4_11=getLk(gamma=0.5,M=3,N1=10,D0=Adjac)

save(Score4_11,file=paste("score",toString(4),toString(11),".rdata",sep=""))
