...
Graph4_12=read.table("Graph4 12 .txt",header=F)
...
Adjac=Adj(Nodes=Graph4_12,nloci=nloci)

Score4_12=getLk(gamma=0.5,M=3,N1=10,D0=Adjac)

save(Score4_12,file=paste("score",toString(4),toString(12),".rdata",sep=""))
