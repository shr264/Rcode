...
Graph3_12=read.table("Graph3 12 .txt",header=F)
...
Adjac=Adj(Nodes=Graph3_12,nloci=nloci)

Score3_12=getLk(gamma=0.5,M=3,N1=10,D0=Adjac)

save(Score3_12,file=paste("score",toString(3),toString(12),".rdata",sep=""))
