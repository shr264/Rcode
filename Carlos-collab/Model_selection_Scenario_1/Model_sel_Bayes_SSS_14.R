...
Graph4_7=read.table("Graph4 7 .txt",header=F)
...
Adjac=Adj(Nodes=Graph4_7,nloci=nloci)

Score4_7=getLk(gamma=0.5,M=3,N1=10,D0=Adjac)

save(Score4_7,file=paste("score",toString(4),toString(7),".rdata",sep=""))
