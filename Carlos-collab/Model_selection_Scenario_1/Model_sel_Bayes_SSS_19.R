...
Graph3_10=read.table("Graph3 10 .txt",header=F)
...
Adjac=Adj(Nodes=Graph3_10,nloci=nloci)

Score3_10=getLk(gamma=0.5,M=3,N1=10,D0=Adjac)

save(Score3_10,file=paste("score",toString(3),toString(10),".rdata",sep=""))
