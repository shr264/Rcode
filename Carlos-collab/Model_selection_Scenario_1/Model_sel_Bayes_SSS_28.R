...
Graph4_14=read.table("Graph4 14 .txt",header=F)
...
Adjac=Adj(Nodes=Graph4_14,nloci=nloci)

Score4_14=getLk(gamma=0.5,M=3,N1=10,D0=Adjac)

save(Score4_14,file=paste("score",toString(4),toString(14),".rdata",sep=""))
