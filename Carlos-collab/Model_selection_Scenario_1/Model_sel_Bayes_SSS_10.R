...
Graph4_5=read.table("Graph4 5 .txt",header=F)
...
Adjac=Adj(Nodes=Graph4_5,nloci=nloci)

Score4_5=getLk(gamma=0.5,M=3,N1=10,D0=Adjac)

save(Score4_5,file=paste("score",toString(4),toString(5),".rdata",sep=""))
