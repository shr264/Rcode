...
Graph4_6=read.table("Graph4 6 .txt",header=F)
...
Adjac=Adj(Nodes=Graph4_6,nloci=nloci)

Score4_6=getLk(gamma=0.5,M=3,N1=10,D0=Adjac)

save(Score4_6,file=paste("score",toString(4),toString(6),".rdata",sep=""))
