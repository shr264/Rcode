...
Graph3_3=read.table("Graph3 3 .txt",header=F)
...
Adjac=Adj(Nodes=Graph3_3,nloci=nloci)

Score3_3=getLk(gamma=0.5,M=3,N1=10,D0=Adjac)

save(Score3_3,file=paste("score",toString(3),toString(3),".rdata",sep=""))
