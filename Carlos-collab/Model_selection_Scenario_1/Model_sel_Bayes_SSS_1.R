...
Graph3_1=read.table("Graph3 1 .txt",header=F)
...
Adjac=Adj(Nodes=Graph3_1,nloci=nloci)

Score3_1=getLk(gamma=0.5,M=3,N1=10,D0=Adjac)

save(Score3_1,file=paste("score",toString(3),toString(1),".rdata",sep=""))
