...
Graph3_5=read.table("Graph3 5 .txt",header=F)
...
Adjac=Adj(Nodes=Graph3_5,nloci=nloci)

Score3_5=getLk(gamma=0.5,M=3,N1=10,D0=Adjac)

save(Score3_5,file=paste("score",toString(3),toString(5),".rdata",sep=""))
