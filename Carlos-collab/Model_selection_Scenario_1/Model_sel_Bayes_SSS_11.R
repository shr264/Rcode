...
Graph3_6=read.table("Graph3 6 .txt",header=F)
...
Adjac=Adj(Nodes=Graph3_6,nloci=nloci)

Score3_6=getLk(gamma=0.5,M=3,N1=10,D0=Adjac)

save(Score3_6,file=paste("score",toString(3),toString(6),".rdata",sep=""))
