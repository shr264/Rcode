...
Graph4_15=read.table("Graph4 15 .txt",header=F)
...
Adjac=Adj(Nodes=Graph4_15,nloci=nloci)

Score4_15=getLk(gamma=0.5,M=3,N1=10,D0=Adjac)

save(Score4_15,file=paste("score",toString(4),toString(15),".rdata",sep=""))
